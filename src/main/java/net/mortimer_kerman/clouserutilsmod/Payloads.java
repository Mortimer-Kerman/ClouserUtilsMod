...
public class Payloads
{
    ...
    public static Identifier PAYLOAD_BOOL = Identifier.of(ClouserUtilsMod.MOD_ID, "bool_payload");
    public static Identifier PAYLOAD_INT = Identifier.of(ClouserUtilsMod.MOD_ID, "int_payload");
    public static Identifier PAYLOAD_FLOAT = Identifier.of(ClouserUtilsMod.MOD_ID, "float_payload");
    public static Identifier PAYLOAD_VEC3D_COUPLE = Identifier.of(ClouserUtilsMod.MOD_ID, "vec3d_couple_payload");
    public static Identifier PAYLOAD_EMPTY = Identifier.of(ClouserUtilsMod.MOD_ID, "empty_payload");
    public static Identifier PAYLOAD_FLOAT_INT = Identifier.of(ClouserUtilsMod.MOD_ID, "float_int_payload");
